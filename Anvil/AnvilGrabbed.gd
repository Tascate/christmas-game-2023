...
func Enter():
	anvil.velocity.x = 0
	anvil.velocity.y = 0
	anvil.set_collision_layer_value(1, false)
	anvil.set_collision_mask_value(1, false)
	print(anvil.player)
...
func Exit():
	...
	anvil.set_collision_layer_value(1, true)
	anvil.set_collision_mask_value(1, true)
	anvil.velocity.x = anvil.throw_horizontal_velocity
